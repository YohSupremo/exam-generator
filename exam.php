...
<header class="exam-header">
    <div class="container">
        ...
        <!-- Subject tag + stat chips + collapsible description (all injected by JS) -->
        <div class="exam-meta" id="exam-meta"></div>

        <!-- Stats target kept for JS compat but rendered inline now -->
        <div id="exam-header-stats" style="display:none"></div>
    </div>
</header>
